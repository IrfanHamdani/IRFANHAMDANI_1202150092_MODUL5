...
import com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.Model.Activity;
...
public class DatabaseListData extends SQLiteOpenHelper{
    ...
    public DatabaseListData(Context context) {
