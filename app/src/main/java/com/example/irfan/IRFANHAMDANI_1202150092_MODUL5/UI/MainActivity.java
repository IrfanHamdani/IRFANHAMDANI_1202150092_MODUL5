package com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.UI;
...
import com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.DatabaseListData;
import com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.R;
import com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.RecyclerAdapter;
import com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.SwipeHelper;

import java.util.LinkedList;

public class MainActivity extends AppCompatActivity {

    private LinkedList<com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.Model.Activity> mActivity = new LinkedList<>();
    private int mCount = 0;

    private RecyclerView mRecyclerView;
    private RecyclerAdapter mAdapter;
    private DatabaseListData databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Check DB
        databaseHandler = new DatabaseListData(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new com.example.irfan.IRFANHAMDANI_1202150092_MODUL5.Model.Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
